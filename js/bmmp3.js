...
class ESjs {
  ...
  circleTrack(obj, speed) {
    ...
    function moveTrack() {
      if (obj.classList.contains("esin")) {
        let combineSpeed =
          speed * Math.abs(scrSpeed) <= speed
            ? speed
            : speed * Math.abs(scrSpeed);
        if (winW <= 768) {
          val += speed;
        } else {
          val += combineSpeed;
  ...
  followCursorInSec(obj, section) {
    ...
    obj.style.transform =
      "translate3d(" + objcenterX + "px," + objcenterY + "px,0)";
    ...
    M = new ((function () {
      ...
      return (
        ...
        (e.p = function (t) {
          ...
          return (
            r.hasAttribute && r.hasAttribute(e) && (n = r.getAttribute(e)),
            n
          );
        }),
        (e.m = function (t) {
            ...
            value: function (t) {
              ...
              if ("number" != typeof t) {
                ...
                ((v = m
                  ...
                  : -this.instance.scroll[this.directionAxis]),
                  (s =
                    "horizontal" === this.direction ? d + s - v : h + s - v));
              } else s = t + s;
...
function drinkFunc() {
  ...
  function changeCup(idx) {
    if (!isChange) {
      ...
      nextImg.setAttribute(
        "src",
        cupArr[idx].querySelector("img").getAttribute("src"),
      );
  ...
  function changeCream(idx) {
    if (idx != 0) {
      ESscroll.scrollTo(creamWrap, { offset: -100 });
    }
    ...
    changeBgImg(
      creamWrap.querySelectorAll(".cream_bigimg figure"),
      idx,
      creamPreIdx,
    );
